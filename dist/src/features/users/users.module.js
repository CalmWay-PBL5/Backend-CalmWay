...
const _usersadmincontroller = require("./users-admin.controller");
const _togglestatushandler = require("./toggle-status/toggle-status.handler");
...
UsersModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            _togglestatushandler.ToggleUserStatusHandler,
